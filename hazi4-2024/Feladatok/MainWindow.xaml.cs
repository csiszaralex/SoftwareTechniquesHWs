    ...
    public sealed partial class MainWindow : Window
    {
        ...
        private void PrepareRaceButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            foreach (var b in game.Bikes)
            {
                ...
                tb.Text = "b";
                bikeTextBlocks.Add(tb);
                bikesPanel.Children.Add(tb);
            }
        ...
        private void UpdateBikeUI(Bike bike)
        {
            ...
            {
                bool isQueued = this.DispatcherQueue.TryEnqueue(() => UpdateBikeUI(bike));
            }
        }
